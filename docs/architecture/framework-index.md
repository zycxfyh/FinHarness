...
| Agent Explanation | Agent 通过 tool 和最小上下文解释状态/风险,不裸读全库、不写核心状态。 | `system-map.md`, `reference/interfaces.md` | `agent_tools.py`, `hermes_bridge.py` | OpenAI Agents/tool calling 作为解释层;不做 source-of-truth | agent tests, future evals |
