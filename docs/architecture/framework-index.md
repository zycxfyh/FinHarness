...
| Review System | append-only proposal review、scaffold revision、attestation、compare、annual review、lesson-to-rule、deterministic review queue triage。 | `system-map.md`, `engineering/system-directory-standard.md` | `statecore/proposals.py`, `review_read.py`, `lesson_loop.py` | GitLab review discipline + decision log;不把 attestation 或 queue priority 当 execution | `GOV-REVIEW-001`, review tests |
