...
| Cockpit/API | current | `api/app.py`, `routes_cockpit.py`, `routes_state.py`, `routes_proposals.py`, `routes_review.py`, `routes_action_intents.py`, `routes_ips.py`, `routes_capital_mandates.py`, `routes_agent_authority_grants.py`, `frontend/` | Read/review/action-intent/authority-binding/capital-mandate/agent-authority-grant validation surface only. No order, transfer, live execution, broker submit, or ceiling-raise endpoint. |
