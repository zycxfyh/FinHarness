...
| Agent Explanation | current v0 | `agent_context.py`, `agent_tools.py`, `hermes_bridge.py` | Read-only Capital OS context packs plus quote/risk-note tools; no source-of-truth writes. |
