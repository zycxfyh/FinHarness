...
状态:current(2026-07-01)。本页只描述**当前 mainline** 的模块事实。历史
...
| Cockpit/API | current | `api/app.py`, `routes_cockpit.py`, `routes_state.py`, `routes_proposals.py`, `routes_review.py`, `routes_action_intents.py`, `routes_ips.py`, `frontend/` | Read/review/action-intent candidate surface only. No order, transfer, live execution, or ceiling-raise endpoint. |
