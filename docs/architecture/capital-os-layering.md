...
| **L5** | Agent / 个人资本 Agent | 这些状态和提案是什么意思? | `agent_context.py`、`agent_capabilities.py`、`agent_tools.py`、`proposal_queue_checks.py`、proposal review surface | ✅ v0:context packs + default read/explain profile + review-draft proposal drafts + review provenance + queue checks |
