...
3. **L6**:`ActionIntentCandidate` 已提供 proposal → future capital action 的
   ...
   TradePlanReviewGate,再进入 OrderTicketCandidate / BrokerSubmissionGate。
