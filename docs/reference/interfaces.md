...
| CockpitInterface | FastAPI + static frontend | Read + governed non-execution write product surface: exposure, IPS, proposals, attestations, governed proposal writes, paper validation, review, no execution endpoints | `task api:serve` |
