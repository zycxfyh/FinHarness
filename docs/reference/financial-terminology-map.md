...
| Supervisory review / approval gate | `TradePlanReviewGate` | Future review gate deciding whether a candidate plan may enter order-ticket staging. | Plan approval status for the next gate. | Broker submission, execution guarantee. | Future review-gate receipts. | Supervisory review / approval workflow. | Approval to stage is not execution. |
