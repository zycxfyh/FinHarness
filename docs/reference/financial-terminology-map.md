...
| Objective fit / benefit case | `CapitalObjectiveFit` | Evidence-bound explanation of how a candidate appears aligned, unclear, or conflicted against user capital objectives, risk budget, liquidity, concentration, reversibility, opportunity cost, alternatives, and next safe path. | Review evidence for human decision quality. | Investment advice, suitability certification, trade-plan approval, order creation, broker submission, execution. | `state_core_capital_objective_fit` receipts. | Goal-based planning / investment committee benefit case. | Objective fit is explanation, not advice or approval. |
