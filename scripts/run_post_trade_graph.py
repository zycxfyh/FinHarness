"""Run tenth-layer post-trade LangGraph workflow."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--flat-fee", type=float, default=0.0)
...
def main() -> int:
    ...
    post_trade_context = {
        "estimated_fee_per_share": args.fee_per_share,
        "estimated_flat_fee": args.flat_fee,
    }
